...
namespace TwitchInVS
{
    ...
    internal sealed class ConfigurationWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("f9a25a7f-1c76-4392-a902-9c2518e49960");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(ConfigurationWindow), 0, true);
